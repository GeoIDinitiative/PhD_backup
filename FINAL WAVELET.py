...
# Config
# ==========================
PEAKS_ROOT = Path("/home/owen/etna_signals_phd/SWCC_utc_fixed")
QUAKE_FILE = Path("/home/owen/etna_signals_phd/earthquakes_merged_utc.csv")
...
def plot_eec1_ecpn_denoised_with_templates(
    ...
    denoised_dir: str = "/home/owen/etna_signals_phd/bandpassed_exports_001_01_csv_only_utc/ingv/",
...
def plot_sync_events_with_templates(
    ...
    denoised_dir_ingv: str = "/home/owen/etna_signals_phd/bandpassed_exports_001_01_csv_only_utc/ingv/",
    denoised_dir_experiment: str = "/home/owen/etna_signals_phd/bandpassed_exports_001_01_csv_only_utc/experiment/",
    ...
    if "snr_linear" not in events_df.columns or events_df["snr_linear"].isna().all():
        ...
        peaks_csv_candidates = [
            ...
            Path("/home/owen/etna_signals_phd/merged_csv/peaks_merged.csv"),
    ...
    eq_csv_candidates = [
        Path("/home/owen/etna_signals_phd/earthquakes_merged_utc.csv")
...
def process_single_event_file(
    event_csv_path: str,
    templates_dir: str = "tilt_templates",
    csv_templates_dir: str = "/home/owen/etna_signals_phd/tilt_templates_csv/experiment/",
    denoised_dir_ingv: str = "/home/owen/etna_signals_phd/bandpassed_exports_001_01_csv_only_utc/ingv/",
    denoised_dir_experiment: str = "/home/owen/etna_signals_phd/bandpassed_exports_001_01_csv_only_utc/experiment/",
    ...
    ----------
    event_csv_path : str
        Path to the event CSV file (e.g., '/home/owen/etna_signals_phd/synchronous_events/event_026.csv')
    templates_dir : str
    ...
    ...     event_csv_path='/home/owen/etna_signals_phd/synchronous_events/event_026.csv',
...
def process_all_events_in_directory(
    events_dir: str = "/home/owen/etna_signals_phd/synchronous_events",
    ...
    **kwargs : dict
    ...
    ...     events_dir='/home/owen/etna_signals_phd/synchronous_events',
    ...     station_dfs=station_map,
...
if __name__ == "__main__":
    ...
    result = process_single_event_file(
        event_csv_path="/home/owen/etna_signals_phd/synchronous_events/event_6745.csv",
        station_dfs=None,  # Replace with station_dfs_dict
        save_dir="./event_6745_output",
        templates_dir="tilt_templates",
        csv_templates_dir="/home/owen/etna_signals_phd/tilt_templates_csv/experiment/",  # Experiment templates
        enable_wavelet_analysis=True,
        debug=True
    )
    ...
    result = process_single_event_file(
        event_csv_path="/home/owen/etna_signals_phd/synchronous_events/event_003.csv",
        station_dfs=station_dfs_dict,  # Replace with station_dfs_dict
        save_dir="./event_003_1_output",
        templates_dir="tilt_templates",
        csv_templates_dir="/home/owen/etna_signals_phd/tilt_templates_csv/ingv/",  # INGV templates
        enable_wavelet_analysis=True,
        debug=True
    )
    
    result = process_single_event_file(
        event_csv_path="/home/owen/etna_signals_phd/synchronous_events/event_103.csv",
        station_dfs=station_dfs_dict,  # Replace with station_dfs_dict
    ...
    print("#     events_dir='/home/owen/etna_signals_phd/synchronous_events',")
...
plot_events_from_csvs(
    ...
    event_csv_path='/home/owen/etna_signals_phd/synchronous_events/event_1311.csv',
...
results = plot_event_windows_with_templates(
    event_csv_path='/home/owen/etna_signals_phd/synchronous_events/event_1311.csv',
    denoised_dir_ingv='/home/owen/etna_signals_phd/bandpassed_exports_001_01_csv_only_utc/ingv/',
    denoised_dir_experiment='/home/owen/etna_signals_phd/bandpassed_exports_001_01_csv_only_utc/experiment/',
...
# Load denoised CSVs
df_ecpn_denoised = pd.read_csv('/home/owen/etna_signals_phd/bandpassed_exports_001_01_csv_only_utc/ingv/ECPN_0p001-0p01Hz_bp.csv')
df_eec1_denoised = pd.read_csv('/home/owen/etna_signals_phd/bandpassed_exports_001_01_csv_only_utc/ingv/EEC1_0p001-0p01Hz_bp.csv')
# or
# df_eec1_denoised = pd.read_csv('/home/owen/etna_signals_phd/bandpassed_exports_001_01_csv_only_utc/experiment/EEC1_0p001-0p01.csv')
